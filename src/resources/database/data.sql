...
INSERT INTO roles (role, user_id) VALUES ('user', (SELECT id FROM users WHERE username='user'));
INSERT INTO roles (role, user_id) VALUES ('admin', (SELECT id FROM users WHERE username='admin'));
